...
function lib:Window(text, preset, closebind)
    ...
    function tabhold:Tab(text)
        ...
        coroutine.wrap(
            function()
                while wait() do
                    TabBtnIndicator.BackgroundColor3 = PresetColorÃ‚  Ã‚  Ã‚ 
                end
            end
        )()
...
Ã‚  Ã‚  Ã‚  Ã‚  Ã‚  Ã‚  Ã‚  Ã‚  pcall(callback)
            end)
        ...
        function tabcontent:Toggle(text, callback)
            ...
            coroutine.wrap(
                function()
                    while wait() do
                        FrameToggle3.BackgroundColor3 = PresetColorÃ‚ Ã‚ 
                    end
                end
            )()
        ...
        function tabcontent:Colorpicker(text, preset, callback)
            ...
            coroutine.wrap(
                function()
                    while wait() do
                        FrameRainbowToggle3.BackgroundColor3 = PresetColorÃ‚ Ã‚ 
                    end
                end
            )()
